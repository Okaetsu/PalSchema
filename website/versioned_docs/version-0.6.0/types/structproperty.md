...
`productDataArray` in `DT_ItemShopCreateData` is an [Array Property](./arrayproperty.md), but the items inside the array are Struct Properties. Below is how you would define a Struct Property in PalSchema:
